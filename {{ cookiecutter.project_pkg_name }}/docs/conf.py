...
# This is set in the setup.py via a command class
...
#
# Due to bugs in the Python docs, have to stipulate some of these
...
#
# Further autodocs config
#

# pick some defaults globally
autodoc_default_options = {
    'members': None,
    'show-inheritance': None,
}

# to get __init__.py documentation visible
